...
export default function WhatWeDo() {
  return (
    ...
    //         <div className='flex flex-col w-1/3 pt-20 p-12 md:border-[4px] rounded-xl shadow-[-3px_12px_46px_-2px_rgba(0,_0,_0,_0.3)] md:border-red-500 border-dotted bg-white '>
    ...
    //         </div>
    //         <div className='flex flex-col w-1/3 p-12 pt-20 md:border-[4px] rounded-xl md:border-red-500 border-dotted shadow-[-3px_12px_46px_-2px_rgba(0,_0,_0,_0.3)] bg-white'>
    //           <h1 className='sm:text-3xl text-2xl font-bold pb-8 '>Create Job <br className='md:hidden' /> Opportunities</h1>
    ...
    //         </div>
    //         <div className='flex flex-col w-1/3 pt-20  p-12 md:border-[4px] rounded-xl md:border-red-500 border-dotted shadow-[-3px_12px_46px_-2px_rgba(0,_0,_0,_0.3)] bg-white'>
    //           <h1 className='sm:text-3xl text-2xl font-bold pb-8 pr-10 xl:text-nowrap'>Promote Environmental <br /> Sustainability</h1>
