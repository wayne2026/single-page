...
export default function NeedSupport() {
  return (
    <div className='w-[85%] mx-auto' >
      <h1 className='text-4xl sm:text-6xl max-lg:text-center font-semibold pb-10 sm:pb-20 sm:pt-16'>WHY WE NEED YOUR SUPPORT </h1>

      <div class="flex items-center justify-center mt-12">
        <div class="grid grid-cols-1 gap-10 sm:grid-cols-1 lg:grid-cols-3">

          <div class="relative bg-white py-6 px-6 rounded-3xl sm:w-[25rem] sm:h-96 h-[26rem]  my-4 shadow-xl">
            <div class=" text-white flex items-center text-center justify-center absolute rounded-full w-16 h-16 shadow-2xl bg-pink-500 left-10 -top-0">
              <img src="/research.png" alt="" className='w-10' />
            </div>
            <div class="mt-8 p-5 ">
              <p class="text-xl font-semibold my-2">Research and Development</p>
              <div class="flex space-x-2 pb-5 pt-3 text-gray-400 text-lg">
          ...
          <div class="relative bg-white py-6 px-6 rounded-3xl sm:w-[25rem] sm:h-96 h-[26rem] my-4 shadow-xl">
            <div class=" text-white flex items-center justify-center absolute rounded-full w-16 h-16 shadow-2xl bg-pink-500 left-10 -top-0">
      ...
      <h1 className='text-2xl md:text-4xl pb-20 pt-16 font-semibold'>HOW YOUR DONATIONS MAKE A DIFFERENCE</h1>
      {/* <div className='flex gap-6 max-sm:flex-col lg:text-sm '>
        <div className='flex flex-col w-1/3 mt-8 gap-5 items-center rounded-xl h-[27rem]  shadow-[-3px_12px_46px_-2px_rgba(0,_0,_0,_0.1)] '>

          <div className=' w-full h-24 bg-[#b1fadd] rounded-t-xl flex flex-col items-center justify-center'>
            <h1 className='text-[1.7rem] font-bold'>Empowering Communities</h1>
          </div>
          <div className='w-[80%] '>
            <p className='text-lg pb-10 font-medium h-60'>
            ...
            <hr className='border-t-4 border-blue-700 w-[75%] rounded-3xl' />
          </div>
        ...
        <div className='flex flex-col w-1/3 mt-8 gap-5 items-center rounded-xl h-[27rem]  shadow-[-3px_12px_46px_-2px_rgba(0,_0,_0,_0.1)] '>
          ...
          <div className=' w-full h-24 bg-[#bfd9ff] rounded-t-xl flex flex-col items-center justify-center'>
            <h1 className='text-[1.7rem] font-bold'>Creating Job Opportunities</h1>
          </div>
          <div className='w-[80%] '>
            <p className='text-lg pb-10 font-medium h-60'>
        ...
        <div className='flex flex-col w-1/3 mt-8 gap-5 items-center rounded-xl h-[27rem]  shadow-[-3px_12px_46px_-2px_rgba(0,_0,_0,_0.1)] '>
          ...
          <div className=' w-full h-24 bg-[#e3bfff] rounded-t-xl flex flex-col items-center justify-center'>
            <h1 className='text-[1.7rem] font-bold'>Promoting Sustainability</h1>
          </div>
          <div className='w-[80%] '>
            <p className='text-lg pb-10 font-medium h-60'>
